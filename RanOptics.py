#!/usr/bin/env python3
# =============================================================================
# RanOptics — Accelerator Optics Plotter  (PySide6 edition)  v2.2.1
#
...
def main():
    ...
    # Apply the saved theme before anything reads a colour: palette values are
    # bound at import and widget stylesheets are built during construction, so
    # this has to happen first or the window comes up half-themed.
    from core.themes import apply_theme, DEFAULT_THEME
    _s = RanOpticsGUI._read_settings()
    apply_theme(_s.get('app_theme', DEFAULT_THEME), _s.get('app_mode', 'dark'))
